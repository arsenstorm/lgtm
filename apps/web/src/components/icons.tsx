...
export function SkillsIcon(props: IconProps) {
  const left =
    "M9 5.25c-1.4-1.15-3.6-1.75-5.75-1.75-.55 0-1 .45-1 1v8.25c0 .55.45 1 1 1 2.15 0 4.35.6 5.75 1.75Z";
  const right =
    "M9 5.25c1.4-1.15 3.6-1.75 5.75-1.75.55 0 1 .45 1 1v8.25c0 .55-.45 1-1 1-2.15 0-4.35.6-5.75 1.75Z";
  return (
    <Base {...props}>
      <path d={left} fill="currentColor" fillOpacity="0.3" />
      <path d={right} fill="currentColor" fillOpacity="0.3" />
      <path {...STROKE} d={left} />
      <path {...STROKE} d={right} />
    </Base>
  );
...
export function CopyIcon(props: IconProps) {
  return (
    <Base {...props}>
      <path
        d="M6.75 6.75H14.25C14.802 6.75 15.25 7.198 15.25 7.75V14.25C15.25 14.802 14.802 15.25 14.25 15.25H7.75C7.198 15.25 6.75 14.802 6.75 14.25V6.75Z"
        fill="currentColor"
        fillOpacity="0.3"
      />
      <path
      ...
      <path
        {...STROKE}
        d="M11.25 4.25V3.75C11.25 3.198 10.802 2.75 10.25 2.75H3.75C3.198 2.75 2.75 3.198 2.75 3.75V10.25C2.75 10.802 3.198 11.25 3.75 11.25H4.25"
      />
    </Base>
  );
}
...
export function LinkIcon(props: IconProps) {
  return (
    <Base {...props}>
      <path {...STROKE} d="M7.25 10.75L10.75 7.25" />
      <path
        {...STROKE}
        d="M8.5 5.5L10.116 3.884C11.478 2.522 13.686 2.522 15.048 3.884L14.116 2.952C15.478 4.314 15.478 6.522 14.116 7.884L12.5 9.5"
      />
      <path
        {...STROKE}
        d="M9.5 12.5L7.884 14.116C6.522 15.478 4.314 15.478 2.952 14.116C1.59 12.754 1.59 10.546 2.952 9.184L4.568 7.568"
      />
    </Base>
  );
}
